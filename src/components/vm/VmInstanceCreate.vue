...
import type { VmCreateFormData } from "../../types/vm-create";
import BasicInfoStep from "./steps/BasicInfoStep.vue";
import ImageSelectStep from "./steps/ImageSelectStep.vue";
import FlavorSelectStep from "./steps/FlavorSelectStep.vue";
